...
(function (ts) {
    var textToToken = {
        "any": 113 /* AnyKeyword */,
        "as": 112 /* AsKeyword */,
        "boolean": 116 /* BooleanKeyword */,
        "break": 67 /* BreakKeyword */,
        "case": 68 /* CaseKeyword */,
        "catch": 69 /* CatchKeyword */,
        "class": 70 /* ClassKeyword */,
        "continue": 72 /* ContinueKeyword */,
        "const": 71 /* ConstKeyword */,
        "constructor": 117 /* ConstructorKeyword */,
        "debugger": 73 /* DebuggerKeyword */,
        "declare": 118 /* DeclareKeyword */,
        "default": 74 /* DefaultKeyword */,
        "delete": 75 /* DeleteKeyword */,
        "do": 76 /* DoKeyword */,
        "else": 77 /* ElseKeyword */,
        "enum": 78 /* EnumKeyword */,
        "export": 79 /* ExportKeyword */,
        "extends": 80 /* ExtendsKeyword */,
        "false": 81 /* FalseKeyword */,
        "finally": 82 /* FinallyKeyword */,
        "for": 83 /* ForKeyword */,
        "from": 129 /* FromKeyword */,
        "function": 84 /* FunctionKeyword */,
        "get": 119 /* GetKeyword */,
        "if": 85 /* IfKeyword */,
        "implements": 103 /* ImplementsKeyword */,
        "import": 86 /* ImportKeyword */,
        "in": 87 /* InKeyword */,
        "instanceof": 88 /* InstanceOfKeyword */,
        "interface": 104 /* InterfaceKeyword */,
        "is": 120 /* IsKeyword */,
        "let": 105 /* LetKeyword */,
        "module": 121 /* ModuleKeyword */,
        "namespace": 122 /* NamespaceKeyword */,
        "new": 89 /* NewKeyword */,
        "null": 90 /* NullKeyword */,
        "number": 124 /* NumberKeyword */,
        "package": 106 /* PackageKeyword */,
        "private": 107 /* PrivateKeyword */,
        "protected": 108 /* ProtectedKeyword */,
        "public": 109 /* PublicKeyword */,
        "require": 123 /* RequireKeyword */,
        "return": 91 /* ReturnKeyword */,
        "set": 125 /* SetKeyword */,
        "static": 110 /* StaticKeyword */,
        "string": 126 /* StringKeyword */,
        "super": 92 /* SuperKeyword */,
        "switch": 93 /* SwitchKeyword */,
        "symbol": 127 /* SymbolKeyword */,
        "this": 94 /* ThisKeyword */,
        "throw": 95 /* ThrowKeyword */,
        "true": 96 /* TrueKeyword */,
        "try": 97 /* TryKeyword */,
        "type": 128 /* TypeKeyword */,
        "typeof": 98 /* TypeOfKeyword */,
        "var": 99 /* VarKeyword */,
        "void": 100 /* VoidKeyword */,
        "while": 101 /* WhileKeyword */,
        "with": 102 /* WithKeyword */,
        "yield": 111 /* YieldKeyword */,
        "async": 114 /* AsyncKeyword */,
        "await": 115 /* AwaitKeyword */,
        "of": 130 /* OfKeyword */,
        "{": 14 /* OpenBraceToken */,
        "}": 15 /* CloseBraceToken */,
        "(": 16 /* OpenParenToken */,
        ...
        "<": 24 /* LessThanToken */,
        ">": 26 /* GreaterThanToken */,
        "<=": 27 /* LessThanEqualsToken */,
        ">=": 28 /* GreaterThanEqualsToken */,
        "==": 29 /* EqualsEqualsToken */,
        "!=": 30 /* ExclamationEqualsToken */,
        "===": 31 /* EqualsEqualsEqualsToken */,
        "!==": 32 /* ExclamationEqualsEqualsToken */,
        ...
        "++": 39 /* PlusPlusToken */,
        "--": 40 /* MinusMinusToken */,
        "<<": 41 /* LessThanLessThanToken */,
        "</": 25 /* LessThanSlashToken */,
        ...
        "+=": 55 /* PlusEqualsToken */,
        "-=": 56 /* MinusEqualsToken */,
        "*=": 57 /* AsteriskEqualsToken */,
        "/=": 58 /* SlashEqualsToken */,
        "%=": 59 /* PercentEqualsToken */,
        "<<=": 60 /* LessThanLessThanEqualsToken */,
        ">>=": 61 /* GreaterThanGreaterThanEqualsToken */,
        ">>>=": 62 /* GreaterThanGreaterThanGreaterThanEqualsToken */,
        "&=": 63 /* AmpersandEqualsToken */,
        "|=": 64 /* BarEqualsToken */,
        "^=": 65 /* CaretEqualsToken */,
        "@": 53 /* AtToken */
    };
    ...
    */
    ...
    function createScanner(languageVersion, skipTrivia, languageVariant, text, onError, start, length) {
        ...
        return {
            ...
            isIdentifier: function () { return token === 66 /* Identifier */ || token > 102 /* LastReservedWord */; },
            isReservedWord: function () { return token >= 67 /* FirstReservedWord */ && token <= 102 /* LastReservedWord */; },
        ...
        function scan() {
            ...
            while (true) {
                ...
                switch (ch) {
                    ...
                    case 33 /* exclamation */:
                        if (text.charCodeAt(pos + 1) === 61 /* equals */) {
                            if (text.charCodeAt(pos + 2) === 61 /* equals */) {
                                return pos += 3, token = 32 /* ExclamationEqualsEqualsToken */;
                            }
                            return pos += 2, token = 30 /* ExclamationEqualsToken */;
                        }
                        return pos++, token = 47 /* ExclamationToken */;
                    case 34 /* doubleQuote */:
                    case 39 /* singleQuote */:
                    ...
                    case 37 /* percent */:
                        if (text.charCodeAt(pos + 1) === 61 /* equals */) {
                            return pos += 2, token = 59 /* PercentEqualsToken */;
                        }
                        return pos++, token = 38 /* PercentToken */;
                    case 38 /* ampersand */:
                        if (text.charCodeAt(pos + 1) === 38 /* ampersand */) {
                            return pos += 2, token = 49 /* AmpersandAmpersandToken */;
                        }
                        if (text.charCodeAt(pos + 1) === 61 /* equals */) {
                            return pos += 2, token = 63 /* AmpersandEqualsToken */;
                        }
                        return pos++, token = 44 /* AmpersandToken */;
                    case 40 /* openParen */:
                    ...
                    case 42 /* asterisk */:
                        if (text.charCodeAt(pos + 1) === 61 /* equals */) {
                            return pos += 2, token = 57 /* AsteriskEqualsToken */;
                        }
                        return pos++, token = 36 /* AsteriskToken */;
                    case 43 /* plus */:
                        if (text.charCodeAt(pos + 1) === 43 /* plus */) {
                            return pos += 2, token = 39 /* PlusPlusToken */;
                        }
                        if (text.charCodeAt(pos + 1) === 61 /* equals */) {
                            return pos += 2, token = 55 /* PlusEqualsToken */;
                        }
                        return pos++, token = 34 /* PlusToken */;
                    case 44 /* comma */:
                        return pos++, token = 23 /* CommaToken */;
                    case 45 /* minus */:
                        if (text.charCodeAt(pos + 1) === 45 /* minus */) {
                            return pos += 2, token = 40 /* MinusMinusToken */;
                        }
                        if (text.charCodeAt(pos + 1) === 61 /* equals */) {
                            return pos += 2, token = 56 /* MinusEqualsToken */;
                        }
                        return pos++, token = 35 /* MinusToken */;
                    case 46 /* dot */:
                    ...
                    case 47 /* slash */:
                        ...
                        if (text.charCodeAt(pos + 1) === 61 /* equals */) {
                            return pos += 2, token = 58 /* SlashEqualsToken */;
                        }
                        return pos++, token = 37 /* SlashToken */;
                    case 48 /* _0 */:
                    ...
                    case 57 /* _9 */:
                        ...
                        return token = 7 /* NumericLiteral */;
                    case 58 /* colon */:
                        return pos++, token = 52 /* ColonToken */;
                    case 59 /* semicolon */:
                    ...
                    case 60 /* lessThan */:
                        ...
                        if (text.charCodeAt(pos + 1) === 60 /* lessThan */) {
                            if (text.charCodeAt(pos + 2) === 61 /* equals */) {
                                return pos += 3, token = 60 /* LessThanLessThanEqualsToken */;
                            }
                            return pos += 2, token = 41 /* LessThanLessThanToken */;
                        }
                        if (text.charCodeAt(pos + 1) === 61 /* equals */) {
                            return pos += 2, token = 27 /* LessThanEqualsToken */;
                        }
                        if (text.charCodeAt(pos + 1) === 47 /* slash */ && languageVariant === 1 /* JSX */) {
                            return pos += 2, token = 25 /* LessThanSlashToken */;
                        }
                    ...
                    case 61 /* equals */:
                        ...
                        if (text.charCodeAt(pos + 1) === 61 /* equals */) {
                            if (text.charCodeAt(pos + 2) === 61 /* equals */) {
                                return pos += 3, token = 31 /* EqualsEqualsEqualsToken */;
                            }
                            return pos += 2, token = 29 /* EqualsEqualsToken */;
                        }
                        if (text.charCodeAt(pos + 1) === 62 /* greaterThan */) {
                            return pos += 2, token = 33 /* EqualsGreaterThanToken */;
                        }
                        return pos++, token = 54 /* EqualsToken */;
                    case 62 /* greaterThan */:
                        if (isConflictMarkerTrivia(text, pos)) {
                            pos = scanConflictMarkerTrivia(text, pos, error);
                            if (skipTrivia) {
                        ...
                        return pos++, token = 26 /* GreaterThanToken */;
                    case 63 /* question */:
                        return pos++, token = 51 /* QuestionToken */;
                    case 91 /* openBracket */:
                    ...
                    case 94 /* caret */:
                        if (text.charCodeAt(pos + 1) === 61 /* equals */) {
                            return pos += 2, token = 65 /* CaretEqualsToken */;
                        }
                        return pos++, token = 46 /* CaretToken */;
                    case 123 /* openBrace */:
                        return pos++, token = 14 /* OpenBraceToken */;
                    case 124 /* bar */:
                        if (text.charCodeAt(pos + 1) === 124 /* bar */) {
                            return pos += 2, token = 50 /* BarBarToken */;
                        }
                        if (text.charCodeAt(pos + 1) === 61 /* equals */) {
                            return pos += 2, token = 64 /* BarEqualsToken */;
                        }
                        return pos++, token = 45 /* BarToken */;
                    case 125 /* closeBrace */:
                        return pos++, token = 15 /* CloseBraceToken */;
                    case 126 /* tilde */:
                        return pos++, token = 48 /* TildeToken */;
                    case 64 /* at */:
                        return pos++, token = 53 /* AtToken */;
                    case 92 /* backslash */:
        ...
        function reScanGreaterToken() {
            if (token === 26 /* GreaterThanToken */) {
                if (text.charCodeAt(pos) === 62 /* greaterThan */) {
                    if (text.charCodeAt(pos + 1) === 62 /* greaterThan */) {
                        if (text.charCodeAt(pos + 2) === 61 /* equals */) {
                            return pos += 3, token = 62 /* GreaterThanGreaterThanGreaterThanEqualsToken */;
                        }
                        return pos += 2, token = 43 /* GreaterThanGreaterThanGreaterThanToken */;
                    }
                    if (text.charCodeAt(pos + 1) === 61 /* equals */) {
                        return pos += 2, token = 61 /* GreaterThanGreaterThanEqualsToken */;
                    }
                    return pos++, token = 42 /* GreaterThanGreaterThanToken */;
                }
                if (text.charCodeAt(pos) === 61 /* equals */) {
                    return pos++, token = 28 /* GreaterThanEqualsToken */;
                }
            }
            return token;
        }
        function reScanSlashToken() {
            if (token === 37 /* SlashToken */ || token === 58 /* SlashEqualsToken */) {
                var p = tokenPos + 1;
                var inEscape = false;
        ...
        function scanJsxToken() {
            ...
            if (char === 60 /* lessThan */) {
                if (text.charCodeAt(pos + 1) === 47 /* slash */) {
                    pos += 2;
                    return token = 25 /* LessThanSlashToken */;
                }
                pos++;
                return token = 24 /* LessThanToken */;
            }
